  ...
  <body>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('postregister') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="login_nama" aria-describedby="emailHelp" name="login_nama">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="login_telepon" aria-describedby="emailHelp" name="login_telepon">
                </div>
                <div class="form-group">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 d-flex justify-content-center">
            Sudah punya akun? Login&nbsp;<a href="{{ route('login') }}">disini</a>&nbsp;sekarang.
        </div>
    </div>
    <!-- plugins:js -->
