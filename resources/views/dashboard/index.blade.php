            ...
            <a href="{{ asset('login-assets') }}/daftarExtra.html">
                <div class="card border-primary ">
                    <div class="card-body text-left">
                        ...
                        <h6 class="card-title font-weight-bold" style="font-size: 1rem; display: inline-block; margin-left: 40px;"> Mendaftar</h6>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{ asset('login-assets') }}/jadwal.html">
                <div class="card border-warning  ">
                    <div class="card-body text-left">
                        ...
                        <h6 class="card-title font-weight-bold text-warning" style=" font-size: 1rem; display: inline-block; margin-left: 40px;">Jadwal</h6>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{ asset('login-assets') }}/kegiatan.html">
                <div class="card border-danger ">
                    <div class="card-body text-left">
                        ...
                        <h6 class="card-title font-weight-bold text-danger" style="font-size: 1rem; display: inline-block; margin-left: 40px;">Kegiatan</h6>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{ asset('login-assets') }}/prestasiExt.html">
                <div class="card border-info ">
                    <div class="card-body text-left">
                        ...
                        <h6 class="card-title font-weight-bold text-info" style="font-size: 1rem; display: inline-block; margin-left: 40px;">Prestasi Extraculicullar</h6>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{ asset('login-assets') }}/prestasiSiswa.html">
                <div class="card border-success ">
                    <div class="card-body text-left">
                        ...
                        <h6 class="card-title font-weight-bold text-success" style="font-size: 1rem; display: inline-block; margin-left: 40px;">Prestasi Siswa</h6>
                    </div>
                </div>
            </a>
        </div>
