    ...
    <nav class="navbar navbar-dark bg-primary shadow mb-5 fixed-top" style="height:85px;">
        <div class="container">
            <a class="navbar-brand" href="#">
                    <img src="{{ asset('login-assets') }}/images/logosmada.png" width="45" height="45" class="d-inline-block align-top" alt=""/>
          ...
          <span class="navbar-text" style="margin-left: auto; font-size: 10px;">
            ...
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-item" href="{{ asset('login-assets') }}/profil.html">
