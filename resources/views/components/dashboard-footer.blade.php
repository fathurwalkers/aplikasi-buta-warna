<div>
    <footer>
        <div class="container-fluid bg-primary fixed-bottom">
            <ul>
                <li><a href="{{ asset('login-assets') }}/siswa.html"><i class="bi bi-house-fill text-light "></i></a>Home</li>
                ...
                <li><a href="{{ asset('login-assets') }}/profil.html"><i class="bi bi-person-circle text-light"></i></a>profil</li>
            </ul>
        </div>
    </footer>
</div>
